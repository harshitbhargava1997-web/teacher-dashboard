...
if filtered_df.empty:
    ...
    with btn_col2:
        metrics_dict = {
            "Total Time Logged": f"{tot_student_time:.1f} Mins",
            "Total Sessions": str(tot_student_sessions),
            "Active Students": str(unique_students),
            "Avg Session Time": f"{avg_time_per_session:.1f} Mins"
        }
        ...
        st.download_button(
            ...
            data=pdf_buf,
            file_name=f"Student_KDM_Report_{selected_school.replace(' ', '_')}.pdf",
